...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.play_drum_number.connect(self.sound.Bongo)
        self.play_guitar_string.connect(self.sound.guitar)
        self.play_piano_note.connect(self.sound.play_piano)
        ...
        self.gui.string1.clicked.connect(lambda: self.play_guitar("e1G"))
